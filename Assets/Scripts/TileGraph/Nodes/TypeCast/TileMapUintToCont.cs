...
{
    /// <summary> Type cast node for converting from Uint to Cont. </summary>
    ...
    public class TileMapUintToContNode : BaseNode
    {
        ...
        protected override void UpdateTileMapOutput(string portName)
        {
            if (portName == "_TileMapOut")
            {
                ...
                _TileMapOutBuffer = _Graph.functionLibrary.tileMapCast.CastUintToCont(matrixIn, _Max, GPUEnabled);
            }
        }
