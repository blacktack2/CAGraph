...
{
    /// <summary> Type cast node for converting from Bool to Cont. </summary>
    ...
    public class TileMapBoolToContNode : BaseNode
    {
        ...
        protected override void UpdateTileMapOutput(string portName)
        {
            ...
            _TileMapOutBuffer = _Graph.functionLibrary.tileMapCast.CastBoolToCont(matrixIn, GPUEnabled);
        }
    }
}
